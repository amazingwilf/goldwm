...
static const double activeopacity   = 0.99f;     /* Window opacity when it's focused (0 <= opacity <= 1) */
...
static const char *fonts[]               = { "Noto Sans:size=20", "SauceCodePro Nerd Font:size=18:style=Bold" };
...
static const Rule rules[] = {
	...
	RULE(.class = "spterm", .scratchkey = 't', .isfloating = 1, .iscentered = 1)
};
...
static const Key keys[] = {
    ...
    { Mod1Mask|ShiftMask,           XK_period,     changefocusopacity,   {.f = +0.025}},
    { Mod1Mask|ShiftMask,           XK_comma,      changefocusopacity,   {.f = -0.025}},
	{ Mod1Mask|ControlMask,         XK_period,     changeunfocusopacity, {.f = +0.025}},
    { Mod1Mask|ControlMask,         XK_comma,      changeunfocusopacity, {.f = -0.025}},
	TAGKEYS(                        XK_1,                                  0)
	TAGKEYS(                        XK_2,                                  1)
	TAGKEYS(                        XK_3,                                  2)
	TAGKEYS(                        XK_4,                                  3)
